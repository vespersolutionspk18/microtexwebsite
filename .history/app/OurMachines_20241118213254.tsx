...
const OurMachines = () => {
  return (
    ...
    <div className="rounded-[12px] h-[240px] bg-cover bg-center" style={{ backgroundImage: URL('/assets/hero.jpg') }}>asd</div>
    </div>
    <div className="h-[600px] w-1/3 bg-white rounded-3xl flex flex-col">.</div>
    <div className="h-[600px] w-1/3 bg-white rounded-3xl">.</div>
    </div>
    </div>
  )
}
