  ...
  return (
    <div className="flex  pt-36 flex-row bg-white pb-16 pr-16 pl-16 mb-20">
        <div className="md:w-[50%] mr-20  flex flex-col justify-between">
            ...
            <div className="group hover:bg-gray-800 flex flex-row items-center justify-between">
  <h5 className="text-gray-800 group-hover:text-white font-light text-justify text-3xl">Learn More</h5>
