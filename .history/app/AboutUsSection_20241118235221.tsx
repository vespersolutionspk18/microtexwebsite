...
const AboutUsSection = () => {
  return (
    <div className="flex flex-row bg-white p-16 mb-20">
        <div className="md:w-[50%] pt-20 flex flex-col justify-between">
            <h3 className="text-gray-800 font-light text-2xl">About Us</h3>
            <h3 className="text-gray-800 font-light text-2xl">Microtex also offers all related spare parts and services for makers and packers. We’re renowned for crafting world class spare parts. We have a huge collection of available spare parts that enable us to meet our clients&apos; requirements on an urgent basis.</h3>
        </div>
