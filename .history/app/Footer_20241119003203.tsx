...
const Footer = () => {
  return (
    <div className="bg-mcred p-16 flex flex-row justify-between gap-16">
        ...
        <div className="md:w-[15%] text-lg flex flex-col text-white">
            <h5>Spare Parts</h5>
            <p className="font-light">MK8/MK9/MK95 Maker Spare Parts<br></br>Hauni Protos 70/80/90 Maker Spare Parts<br></br>
            Molins HLP Packer Spare Parts<br></br>
            GD X1 & GD X2 Packer Spare Parts<br></br>
