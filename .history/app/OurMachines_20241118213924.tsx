...
const OurMachines = () => {
  return (
    ...
    <h3 className="text-3xl text-gray-700 text-left pt-2 pb-2">MARK8-D WITH MAX-15</h3>
    <div className="flex flex-row items-center justify-stretch">
        <h5 className="text-gray-600 text font-light">Format</h5>
        <h5 className="text-gray-600 text font-light"> King / Demi / Slims / Super Slims / NANO</h5>
    </div>
    </div>
