...
const OurMachines = () => {
  return (
    ...
    <Separator className="bg-gray-600 mt-1 mb-2" />
    <div id="button"
  className="group mt-10 bg-gray-800 h-[44px] flex-row  text-white text-[16px] py-1 px-1 font-light rounded-full hidden md:flex items-center justify-between w-[190px] transition-width duration-500 ease-in-out  hover:w-[215px] hover:bg-mcred"
