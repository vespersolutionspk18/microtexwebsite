  ...
  return (
    <div className="flex h-[640px] flex-row bg-white p-16 mb-20">
        <div className="md:w-[50%] mr-20 pt-20 flex flex-col justify-between">
            ...
            <div id="button"
  className="group mt-12 border-gray-900 border-[1px] bg-white h-[44px] flex-row  text-gray-800 text-[16px] py-1 px-1 font-light rounded-full hidden md:flex items-center justify-between w-[180px] transition-width duration-500 ease-in-out  hover:w-[205px] "
